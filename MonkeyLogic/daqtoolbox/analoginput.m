    ...
    methods
        ...
        function chans = addchannel(obj,hwch,varargin)
            ...
            for m=1:nchan
                ...
                chans(m).InputRange = obj.hwInfo.InputRanges(1,:);
                chans(m).SensorRange = obj.hwInfo.InputRanges(1,:);
                chans(m).UnitsRange = obj.hwInfo.InputRanges(1,:);
        ...
        function flushdata(obj,mode)
            ...
            for m=1:length(obj)
                ...
                daqmex(22,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID,strcmpi(modeSet(2),mode));
            end
        end
        function varargout = getdata(obj,nsamples)
            if 1 < length(obj), error('OBJ must be a 1-by-1 analog input object.'); end
            switch nargin
                case 1, [data,info] = daqmex(11,obj.AdaptorName,obj.DeviceID,obj.TaskID);
                otherwise, [data,info] = daqmex(11,obj.AdaptorName,obj.DeviceID,obj.TaskID,nsamples);
            end
            varargout{1} = data';
            if 1<nargout
            ...
            if 3<nargout
                if isempty(info.AbsSample)
                    ...
                    events = daqmex(23,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,info.AbsSample(1,1),info.AbsSample(end,2));
                    for m=1:length(events), events(m).Data.AbsTime = datevec(events(m).Data.AbsTime); end
                    varargout{4} = events;
                end
            end
        ...
        function set.InputType(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputType',validateStringSet(obj,'InputType',val)); %#ok<*MCSUP>
        end
        function val = get.InputType(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputType');
        end
        ...
        function set.LoggingMode(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'LoggingMode',validateStringSet(obj,'LoggingMode',val));
        end
        function val = get.LoggingMode(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'LoggingMode');
        end
        function set.ManualTriggerHwOn(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerHwOn',validateStringSet(obj,'ManualTriggerHwOn',val));
        end
        function val = get.ManualTriggerHwOn(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerHwOn');
        end
        ...
        function set.SamplesPerTrigger(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SamplesPerTrigger',numchk(obj,val));
        end
        function val = get.SamplesPerTrigger(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SamplesPerTrigger');
        end
        function set.TriggerChannel(obj,ch)
            if ~strcmpi(class(ch),'aichannel'), error('Invalid or deleted object.'); end
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerChannel',ch.Index);
        end
        function val = get.TriggerChannel(obj)
            val = obj.Channel(daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerChannel'));
        end
        function set.TriggerCondition(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerCondition',validateStringSet(obj,'TriggerCondition',val));
        end
        function val = get.TriggerCondition(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerCondition');
        end
        function set.TriggerConditionValue(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerConditionValue',numchk(obj,val,2));
        end
        function val = get.TriggerConditionValue(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerConditionValue');
        end
        function set.TriggerDelay(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelay',numchk(obj,val));
        end
        function val = get.TriggerDelay(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelay');
        end
        function set.TriggerDelayUnits(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelayUnits',validateStringSet(obj,'TriggerDelayUnits',val));
        end
        function val = get.TriggerDelayUnits(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelayUnits');
        end
        function set.TriggerRepeat(obj,val)
            daqmex(5,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerRepeat',numchk(obj,val));
        end
        function val = get.TriggerRepeat(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerRepeat');
        end
        ...
        function val = get.InputTypeSet(obj)
            val = daqmex(6,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputTypeSet');
        end
